...
public class Exercise03_11 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter integer for month (1 for January , 2 for February ..):");
		int month = input.nextInt();
		
		System.out.print("Enter integer for year :");
		...
		case 2:System.out.println("February " + year +((isLeapYear) ? " had 29 days" : "had 28 days"));break;
